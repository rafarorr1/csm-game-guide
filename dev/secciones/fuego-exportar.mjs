...
export const cartasFuego=Object.freeze(['tal','machete','rey','bartolomeo','eric']);
...
export function exportar(destino){
  ...
  const procedencia={seccion:'fuego',partida:false,almacenamiento:'ninguno',proposito:'Pruebas de animación de Thal: entrada con brillo verde y onda de ácido sobre las afectadas; ataque con fuego verde que no mata; ataque letal que quema la carta hasta la ceniza; y la muerte de Machete, que arde hasta la ceniza como en la partida.',
