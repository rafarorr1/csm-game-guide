...
export const componentesVisorGpu=Object.freeze(['carta-pintor.js','carta-diseno.css','visor-3d-gl.js','visor-3d-gpu.js','fuentes/cinzel.woff2','fuentes/cormorant-garamond.woff2','fuentes/cormorant-garamond-italica.woff2']);
...
export function exportar(destino){
  ...
  const procedencia={seccion:'visor-gpu',partida:false,almacenamiento:'ninguno',proposito:'Prueba del visor 3D en WebGPU con El Mago del Domo, junto al mismo visor en WebGL para compararlos.',
