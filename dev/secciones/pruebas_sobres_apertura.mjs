...
if(process.argv.includes('--sabotaje')){
  ...
  const casos=[
    ...
    ['resumen antes de la quinta',resumenSoloOtroToque,enFuncion(fuente,"brillo.classList.add('encendido');",'function activar(){',s=>reemplazar(s,"cambiar(reveladas===cartas.length?'ultima':'pila');","cambiar(reveladas===cartas.length-1?'ultima':'pila');"))],
    ['avance automático tras la quinta',resumenSoloOtroToque,enFuncion(fuente,"brillo.classList.add('encendido');",'function activar(){',s=>reemplazar(s,"cambiar(reveladas===cartas.length?'ultima':'pila');","cambiar(reveladas===cartas.length?'ultima':'pila');if(fase==='ultima')setTimeout(()=>reunir(),900);"))],
