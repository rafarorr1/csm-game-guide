...
import {derivarPoderes,pagina as paginaPoderes} from './poderes-exportar.mjs';
import {derivarLugares,pagina as paginaLugares} from './lugares-exportar.mjs';
import {derivarCampos,pagina as paginaCampos} from './estudio-campos-exportar.mjs';
import {derivarCortinilla,pagina as paginaCortinilla} from './cortinilla-exportar.mjs';
import {derivarInvocar,pagina as paginaInvocar} from './invocar-exportar.mjs';
...
const publicos=new Set(['coleccion.html','interacciones.html','epilogo-gero.html','pitagoras.html','heroe.html','mulligan.html','invitaciones.html','estudio-nombres.html','memoria.js','red-estatica.js','coleccion-dev.js','aislado.css','interacciones.js','interacciones.css','epilogo-gero.js','epilogo-gero.css','pitagoras.js','pitagoras.css','heroe.css','heroe-host.js','heroe.js','mulligan.js','mulligan.css','invitaciones.js','invitaciones.css','estudio-nombres.js','estudio-nombres.css','cartas.js','cartas.css','fuego.js','fuego.css','poderes.js','poderes.css','lugares.js','lugares.css','estudio-campos.js','estudio-campos.css','cortinilla-mesa.js','cortinilla-mesa.css','invocar-mesa.js','invocar-mesa.css','visor-gpu-mesa.js','visor-gpu-mesa.css','teaser-reloj.js','teaser-mesa.js','teaser-mesa.css','cuenta-lab.css','cuenta-lab.js','cuenta-demo.js','cuenta-fondo.css']);
const componentes=new Set(['arte-vistas.js','coleccion-modelo.js','arte-remoto.js','coleccion-ui.js','visor-3d.js','visor-3d-gl.js','visor-3d.css','carta-pintor.js','carta-diseno.js','carta-diseno.css','carta-juego.js','carta-juego.css','fx-aliento.js','fx-ascension.js','fx-poderes.js','campo-lugar.js','cortinilla.js','fx-invocar.js','visor-3d-gpu.js','tormenta-gl.js','tormenta-gpu.js','fuentes/cinzel.woff2','fuentes/cormorant-garamond.woff2','fuentes/cormorant-garamond-italica.woff2','sobres-escena.js','sobres-apertura.js','sobres-revelacion.js','sobres-apertura.css','coleccion.css','acabados.css','campana-deseo.js','campana-personaje.js','cuenta-modelo.js','cuenta-progreso.js','cuenta-servicio.js','cuenta-acceso.js','cuenta-ui.js','cuenta.css','pitagoras-pruebas.js','pitagoras-mundos.js','pitagoras-cine.js','pitagoras-pixel.js','mulligan-ui.js','mulligan-ui.css','invitaciones-compartidas.js','nombres-cartas.js']);
...
export function crearServidor(){return http.createServer((req,res)=>{
  try{
    ...
    if(recurso==='poderes.html')return enviar(res,200,paginaPoderes('./generado/poderes'),mime['.html']);
    if(recurso==='generado/poderes/datos.js')return enviar(res,200,derivarPoderes().datosJS,mime['.js']);
    if(recurso==='lugares.html')return enviar(res,200,paginaLugares('./generado/lugares'),mime['.html']);
    if(recurso==='generado/lugares/datos.js')return enviar(res,200,derivarLugares().datosJS,mime['.js']);
    if(recurso==='estudio-campos.html')return enviar(res,200,paginaCampos('./generado/estudio-campos'),mime['.html']);
    if(recurso==='generado/estudio-campos/datos.js')return enviar(res,200,derivarCampos().datosJS,mime['.js']);
    if(recurso==='cortinilla.html')return enviar(res,200,paginaCortinilla('./generado/cortinilla'),mime['.html']);
    if(recurso==='generado/cortinilla/datos.js')return enviar(res,200,derivarCortinilla().datosJS,mime['.js']);
    if(recurso==='invocar.html')return enviar(res,200,paginaInvocar('./generado/invocar'),mime['.html']);
    if(recurso==='generado/invocar/datos.js')return enviar(res,200,derivarInvocar().datosJS,mime['.js']);
    if(recurso==='visor-gpu.html')return enviar(res,200,paginaVisorGpu('./generado/visor-gpu'),mime['.html']);
    if(recurso==='generado/visor-gpu/datos.js')return enviar(res,200,derivarVisorGpu().datosJS,mime['.js']);
    if(recurso==='teaser.html')return enviar(res,200,paginaTeaser('./generado/teaser'),mime['.html']);
    if(recurso==='generado/teaser/datos.js')return enviar(res,200,derivarTeaser().datosJS,mime['.js']);
