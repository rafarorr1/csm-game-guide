...
(function(){
  ...
  function preparar(){
    ...
    if(estado==='sobres'){m.darSobreBeta();m.darSobreBeta();}
    if(estado==='ediciones'){
    ...
    form.addEventListener('submit',e=>{e.preventDefault();location.search=new URLSearchParams({vista:form.elements.vista.value,estado:form.elements.estado.value}).toString();});
