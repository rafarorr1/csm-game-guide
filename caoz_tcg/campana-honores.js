...
(function(){
  ...
  window.campanaActualizarHonores=function(){actualizarMarcas();actualizarNombre();};
...
`;document.head.appendChild(s);
    ...
    const anterior=window.showScreen;if(anterior)window.showScreen=function(...args){const r=anterior.apply(this,args);actualizarNombre();return r;};
