...
- La mano, la mesa, las cartas reveladas y la ficha ampliada usan el diseño de
  ...
  gemas, con el relieve iluminado. Foil y Dorada conservan su metal y su reflejo.
- El coste, el ataque y la vida siguen vivos encima de sus gemas: una rebaja o
  una mejora se ven en verde y una herida en rojo, sin repintar la carta. En
  cartas pequeñas (la mesa del teléfono) las gemas crecen para leerse.
- La ficha ampliada muestra la carta entera y legible; debajo siguen las
  chapas, los objetos equipados y la base/ahora.
- La mano del rival se ve con el dorso del visor 3D, con el logo.
- Cada cara se pinta una vez y se reutiliza; mientras se pinta la primera, la
  carta se ve con el diseño anterior. Nueva suite `cartaPintada` y sección
  aislada `cartas` (escritorio y teléfono).
...
- Colección con tres cartas por fila, scroll vertical y separación compacta;
  conserva posición y foco al volver del detalle, acabados, sobres e inventario.
...
- Validación completa verde: seis tutoriales, regresiones, campaña/online,
  vistas de Colección en móvil/escritorio y catálogo del estudio sincronizado.
- Banco integrado de 2880 partidas: Mohamed 42.4%, Fender 41.8%, Adreida 53.2%,
  Gero 68.3%, Rafaela 51.1%, Talesin 43.1%. Cero errores/partidas sin terminar,
  ninguna carta sin jugar ni trampa sin activarse; 81 victorias por corte,
  281 por Pergamino y 2518 por Alma. Gero sigue favorecido en IA contra IA;
  esta entrega reduce el atajo de El Rey, no declara equilibrio global.
...
- **El paso a «Elige a tu rival» se funde- **El paso a «Elige a tu rival» se funde, y las cartas del fondo son las de verdad** (build 118).
  ...
  **Las cartas que vuelan son cartas de verdad.** Ya no son dorsos genéricos: son las de los
  seis Protagonistas, con su retrato y su nombre — y en **formato de naipe**, vertical. La
  primera versión usó la tarjeta apaisada del carrete, que es un panel de información y no una
  carta; la buena es `.vscard`, la vertical que ya existía porque la usa la cortinilla del VS.
  La caja de fuera es la que se mueve y dentro va la carta a tamaño real encogida con `scale`,
  así que el diseño es **exactamente el mismo** que se ve al empezar una partida y no una
  imitación que haya que mantener en dos sitios. Con seis Líderes y doce cartas, cada uno sale
  dos veces.
