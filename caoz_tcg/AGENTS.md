...
| `visor-3d.js`, `visor-3d.css`, `visor-3d-gl.js` | Visor 3D desde el detalle de Colección. Con WebGL propio (sin dependencias) dibuja la carta con luz, relieve, metal, laca y holo; sin WebGL, capas CSS sin `preserve-3d`. Sólo dibuja. |
