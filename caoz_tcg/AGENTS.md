...
| `carta-diseno.js`, `carta-diseno.css`, `fuentes/` | Diseño de las cartas en Colección y visor 3D: clásico en Normal/Foil, full art en Dorada. Datos de `CARDS`, ilustración por el proveedor de arte. Tipografías OFL alojadas en `fuentes/`. |
| `visor-3d.js`, `visor-3d.css` | Visor 3D de una carta desde el detalle de Colección: la ficha real con canto, reflejo, foil y dorso con el logo. Sólo dibuja; sin WebGL ni `preserve-3d`. |
