...
PRUEBAS.suite('regresiones', async t => {
     ...
     del acceso y conserva el código visible. */
  {
    ...
    const prod='https://juego.caozcontodo.com/?b=269',beta='https://beta.caoz-tcg.pages.dev/?b=269';
    t.igual(inv.codigo('https://juego.caozcontodo.com/?sala=a-b1c2&b=269'), 'AB1C2',
